...
Reads PAT from local-workspace/kuronami-mods/tools/.tokens/.modrinth_token.
"""
...
TOKEN_PATH = Path(
    str(__import__('pathlib').Path(__import__('os').environ['KURONAMI_TOKEN_DIR']) / '.modrinth_token')
)
